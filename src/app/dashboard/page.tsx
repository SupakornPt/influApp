  ...
  return (
    <section className="space-y-8">
      ...
      <div className="flex flex-wrap gap-3">
        <button className={cn("rounded-xl px-4 py-2 text-sm font-semibold transition", pageBtn)}>Find Campaigns</button>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <article className="rounded-2xl bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 flex gap-2">
            <button className={cn("rounded-lg px-3 py-1.5 text-sm font-semibold transition", pageBtn)}>Submit Work</button>
        ...
        <article className="rounded-2xl bg-white p-5 shadow-sm">
          ...
          <button className={cn("mt-4 rounded-lg px-3 py-1.5 text-sm font-semibold transition", pageBtn)}>Open Chat</button>
        </article>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <article className="rounded-2xl bg-white p-5 shadow-sm">
          ...
          <button className={cn("mt-4 rounded-lg px-3 py-1.5 text-sm font-semibold transition", pageBtn)}>Edit Profile</button>
        </article>
      </div>
