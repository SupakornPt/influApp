      ...
      <div className="relative">
        {canScrollLeft && (
          <button
            ...
            onClick={() => scroll("left")}
            className={cn(
              "absolute left-0 top-1/2 z-30 flex size-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 text-slate-800 shadow-lg ring-1 ring-slate-200 transition",
        ...
        {canScrollRight && (
          <button
            ...
            className={cn(
              "absolute right-0 top-1/2 z-30 flex size-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 text-slate-800 shadow-lg ring-1 ring-slate-200 transition",
              "hover:bg-white hover:scale-105",
              isHovered ? "opacity-100" : "pointer-events-none opacity-0"
            )}
          >
